...
import { getCaretCoordinates, getCurrentWord, replaceWord, people } from ".";
	...
	return (
		<div className="relative w-full">
			<Textarea
				...
				autoComplete="off"
				autoCorrect="off"
				className="h-auto min-h-[80vh] resize-none focus-visible:ring-neutral-700"
				value={textValue}
				onChange={onTextValueChange}
				rows={5}
			/>
			<p className="prose-none mt-1 text-xs text-muted-foreground">
				Supports markdown.
			</p>
			<Command
				ref={dropdownRef}
